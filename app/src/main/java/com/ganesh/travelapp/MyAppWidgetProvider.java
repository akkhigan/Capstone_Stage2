...
import com.ganesh.travelapp.Activity.MainActivity;
import com.ganesh.travelapp.Utils.DatabaseSave;
...
/**
 * This class provides a widget provider features
 */
public class MyAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int widgetId : allWidgetIds) {
            ...
            Cursor data = new DatabaseSave(context).getSavedPlaces();
            if (data.moveToFirst()) {
